<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="{{ in_array(Request::route()->getName(),['admin.customer.manage.form','admin.customer.edit']) ? ' active' : '' }}">
                <a class="nav-link" href="{{ route('admin.customer.manage.form') }}"  data-toggle="tooltip" data-original-title="{{ __('pages.customer.add') }}"><i class="fas fa-cogs "></i> <span>{{ __('pages.customer.add') }}</span></a>
            </li>
            ...
            <li class="{{ in_array(Request::route()->getName(),['admin.customer']) ? ' active' : '' }}">
