        ...
        <div class="col-xl-12">
            <div class="contenttopbar">
                <ul class="d-flex align-content-center float-right assigned-order">
                    <a href="{{ $add_route }}" class="btn btn-primary">
                        <i class="fas fa-plus"></i> {{ $add_title }}
                    </a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_customer', function(e) {
                ...
                var confirmMsg = "{{ __('admin_message.customer_msg.confirm_delete') }}";
                var deleteRoute = "{{ route('admin.customer.delete') }}";
        ...
        function customerList() {
            ...
            var url = "{{ route('admin.customer.list') }}";
