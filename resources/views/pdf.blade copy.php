            ...
            <div class="pdf-file">
              ...
              <div class="customer-detail">
                <div class="detail name">
                  ...
                  <span class="dot">:</span>
                  <span class="text">{{ $client->clientDetail->client_name ?? ''}}
                  </span>
                </div>
                <div class="detail address">
                  ...
                  <span class="dot">:</span>
                  <span class="text"
                    >{{ $client->clientDetail->address ?? ''}}- {{ $client->clientDetail->pin_code ?? ''}}</span
                  >
                </div>
                <div class="detail">
                  <span class="title">Invoice</span>
                  <span class="dot">:</span>
                  <span class="text">{{ $client->clientDetail->invoice ?? ''}}</span>
                </div>
              </div>
              @endforeach
            </div>
